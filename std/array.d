...
if (isDynamicArray!A)
{
     ...
     */
    void put(U)(U item) if (FixedAppender!A.canPutItem!U)
    {
        ensureInit();
        impl.put(item);
    }
    ...
    // Const fixing hack.
    void put(Range)(Range items) if (FixedAppender!A.canPutConstRange!Range)
    {
        if (!items.empty)
        {
            ensureInit();
     ...
     */
    void put(Range)(Range items) if (FixedAppender!A.canPutRange!Range)
    {
        if (!items.empty)
        {
            ensureInit();
...
if (isDynamicArray!A)
{
    ...
    static string toStringImpl(Q)(string typeName, Q[] arr)
    {
    ...
    static void toStringImpl(Writer, Q)(string typeName, Q[] data, scope ref Writer w, scope const ref FormatSpec!char fmt)
    {
